 ...
 */
export async function register(email: string, password: string, name?: string): Promise<IAuthResult> {
 ...
 */
export async function createShare(fileId: string, expiresAt?: string, permissions: string[] = ["read"]): Promise<IShare> {
...
export async function createCollabSession(payload: { name?: string; fileId?: string } = {}): Promise<any> {
